...
do
  local __nixvim_binds = {
    ...
    { action = "<CMD>nohlsearch<Bar>:echo<CR>", key = "<ESC>",     mode = "n", options = { desc = "Cancel search" } },
    { action = "<CMD>wa<CR>",                   key = "<Leader>s", mode = "n", options = { desc = "Save all" } },
    { action = "<C-o>",                         key = "<C-[>",     mode = "n", options = { desc = "Jump back to last entry in jumplist" } },
    { action = "<C-i>",                         key = "<C-]>",     mode = "n", options = { desc = "Jump forward to next entry in jumplist" } },
    { action = "<CMD>Telescope registers<CR>",  key = '""',        mode = "n", options = { desc = "View the registers" } },
    {
      action = function()
    ...
    { action = "<CMD>split<CR>",  key = "<Leader>n", mode = "n", options = { desc = "Make a new horizontal split" } },
    { action = "<CMD>vsplit<CR>", key = "<Leader>N", mode = "n", options = { desc = "Make a new vertical split" } },
    {
    ...
    { action = "<CMD>wincmd H<CR>", key = "<Leader><Left>", mode = "n", options = { desc = "Send window to Left" } },
    { action = "<CMD>wincmd J<CR>", key = "<Leader><Down>", mode = "n", options = { desc = "Send window to Down" } },
    { action = "<CMD>wincmd K<CR>", key = "<Leader><Up>",   mode = "n", options = { desc = "Send window to Up" } },
    {
      action = "<CMD>wincmd L<CR>",
      key = "<Leader><Right>",
      mode = "n",
    ...
    { action = "<CMD>vertical resize +5<CR>", key = "<Left>",  mode = "n" },
    { action = "<CMD>resize +5<CR>",          key = "<Down>",  mode = "n" },
    { action = "<CMD>resize -5<CR>",          key = "<Up>",    mode = "n" },
    { action = "<CMD>vertical resize -5<CR>", key = "<Right>", mode = "n" },
    {
    ...
    { action = "<cmd>lua require('oil').open()<cr>", key = "-",    mode = "n", options = { desc = "View files" } },
    { action = "<CMD>OverseerRun<CR>",               key = "<BS>", mode = "n", options = { desc = "Run task" } },
    {
